...
export type { GameControllerHooks, GameControllerLeftControl, } from './components/game-controller/game-controller';
export type { GcAncillaryId, GcAncillaryPressDetail, } from './components/gc-ancillary-buttons/gc-ancillary-buttons';
...
export type { GcJoystickCardinal, GcJoystickMoveDetail, JoystickSector, } from './components/gc-joystick/gc-joystick';
export { DEFAULT_JOYSTICK_SECTORS, GcJoystickElement, } from './components/gc-joystick/gc-joystick';
