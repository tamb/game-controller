...
function addVibrations() {
    var buttons = document.querySelectorAll(".game-controller__container button");
                    ...
                    fullscreen: createElement({
                        ...
                        attributes: [
                            [
                                "classes",
                                [
                                    "game-controller__ancillary-btn"
                                ]
                            ],
                            [
                                "type",
                ...
                this.refs.mainControls = createElement({
                    ...
                    attributes: [
                        [
                            "classes",
                            [
                                "game-controller__main-controls"
                            ]
                        ]
                    ]
                });
                    ...
                    container: createElement({
                        ...
                        attributes: [
                            [
                                "classes",
                                [
                                    "game-controller__d-pad-container"
                                ]
                            ]
                        ]
                    }),
                    up: createElement({
                        ...
                        attributes: [
                            [
                                "classes",
                                [
                                    "game-controller__d-pad-btn",
                                    "game-controller__d-pad-btn--up"
                                ]
                            ]
                        ]
                    }),
                    right: createElement({
                        ...
                        attributes: [
                            [
                                ...
                                [
                                    "game-controller__d-pad-btn",
                                    "game-controller__d-pad-btn--right"
                                ]
                            ]
                        ]
                    }),
                    down: createElement({
                        ...
                        attributes: [
                            [
                                ...
                                [
                                    "game-controller__d-pad-btn",
                                    "game-controller__d-pad-btn--down"
                                ]
                            ]
                        ]
                    }),
                    left: createElement({
                        ...
                        attributes: [
                            [
                                ...
                                [
                                    "game-controller__d-pad-btn",
                                    "game-controller__d-pad-btn--left"
                                ]
                            ]
                        ]
                    })
                        ...
                        attributes: [
                            [
                                ...
                                [
                                    ...
                                    "game-controller__action-btn--".concat(i + 1)
                                ]
                            ]
                        ],
                    ...
                    attributes: [
                        [
                            ...
                            [
                                ...
                                "".concat(this.actions === 2 ? "game-controller__actions--two" : "game-controller__actions--four")
                            ]
                        ]
                    ]
                });
...
function createController() {
    ...
    document.querySelector(".game-controller__stage").addEventListener("click", function() {
        console.log("click");
